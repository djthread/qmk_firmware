...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_thread(
    _______, M_ENPASS,   KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSLS, M_CMDTAB, _______, \
    M_TEXTMATE, M_DASH,   KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC, _______, \
    M_VOX, KC_F,   KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP, \
    KC_G, KC_H,   KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PGDN, \
    KC_I, KC_J,   KC_LCTL, MO(_FN2), KC_SPC, KC_LALT, KC_LGUI, MO(_FN1),    KC_SPC, MO(_FN1), KC_RGUI, MO(_FN2), KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_thread(
    ...
    RGB_TOG, RGB_MOD, M_CMDTAB, M_CMDBT, KC_MS_BTN2, KC_MS_UP, KC_MS_BTN1, KC_MS_WH_UP, KC_PGUP, KC_HOME, KC_UP, KC_END, M_FOCUSVIEW, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, KC_DEL, _______, \
  ...
  [_FN2] = LAYOUT_thread(
    _______, M_ENPASS_POP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
