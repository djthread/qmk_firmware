...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_thread(
    KC_A,   KC_B,   KC_GRV, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS,  M_CMDTAB, KC_B, \
    KC_C,   KC_D,   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC, KC_C, \
    ...
    KC_I,   KC_J,   KC_LCTL, KC_1, KC_2, KC_LALT, KC_LGUI, MO(_FN1),    KC_SPC, MO(_FN1), KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_thread(
    ...
    _______, _______, M_CMDTAB, M_CMDBT, KC_MS_BTN2, KC_MS_UP,  KC_MS_BTN1, KC_MS_WH_UP, KC_PGUP, KC_HOME, KC_UP, KC_END, M_FOCUSVIEW, M_MTOGG, M_MNEXT, KC_DEL, _______, \
