...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP(
        ...
        KC_LSFT,KC_NO,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, RSFT(KC_SLSH), KC_UP,  M_BUILDINST, //MO(_FUNCTION2),
        KC_LCTL,KC_LALT,KC_LGUI,    KC_1,            KC_SPC,  KC_2,                KC_RGUI,MO(_FUNCTION),      KC_LEFT,KC_DOWN,KC_RIGHT
  ),
  /*
  [_NAVIGATION] = KEYMAP(
        M_CMD_H, KC_F1,  KC_F2,  KC_F3,  M_CHATTERM,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, M_APPTERM, KC_F12, _______,     KC_HOME,
        M_CMDTAB,M_CMDBT,KC_MS_BTN2,KC_MS_UP,KC_MS_BTN1,KC_MS_WH_UP,KC_PGUP,KC_HOME,KC_UP,KC_END,M_FOCUSVIEW,M_MTOGG,M_MNEXT,KC_DEL,     KC_END,
