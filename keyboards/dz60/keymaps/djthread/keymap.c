...
/*
  [_ALTLAYER] = LAYOUT_thread(
    ...
    M_BARTENDERSHOW, M_TEAMS, KC_F5, M_OUTLOOK, M_WTL, M_WTR,  M_WTOP, M_WLEFT, M_WRIGHT, M_WMAX, M_WNEXTMON, M_NEWBROWSER,     KC_PGUP,
...
*/
  ...
  [_SYS] = LAYOUT_thread(
    ...
    _______, _______, _______,       _______, M_PBOT_OFF, M_PBOT_ON,        _______, _______, _______, KC_F14, KC__VOLDOWN
  ),
