...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_FN2] = LAYOUT_thread(
        ...
        _______,_______,_______,_______,_______,         _______,                _______,_______,     TO(_ARROWS),_______,KC_END
  ),

  [_SYS] = LAYOUT_thread(
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______, _______, _______, M_BUILDINST,
