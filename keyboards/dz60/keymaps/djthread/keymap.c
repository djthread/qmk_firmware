...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ARROWS] = LAYOUT_thread(
    ...
    _______, _______, _______,      _______, _______, TG(_ARROWS),         _______, MO(_ARROWS2), KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  ...
  [_FN2] = LAYOUT_thread(
    _______, M_PBOT_Z1_ON, M_PBOT_Z2_ON, M_PBOT_Z3_ON, M_PBOT_Z4_ON, _______, _______, _______, _______, M_PBOT_ON, M_PBOT_OFF, _______, _______, _______, _______,
    _______, M_PBOT_Z1_OFF, M_PBOT_Z2_OFF, M_PBOT_Z3_OFF, M_PBOT_Z4_OFF, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TO(_CHOONS),     KC_HOME,
    _______, _______, _______,      _______, M_PBOT_OFF, M_PBOT_ON,         _______, TO(_WEB), TG(_ARROWS), _______, KC_END
  ),
