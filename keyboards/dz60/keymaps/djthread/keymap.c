...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_ARROWS2] = LAYOUT_thread(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP,     KC_PGUP,     KC_PGDN,
  ...
  [_FN1] = LAYOUT_thread(
    ...
    _______, _______, _______, _______, _______, M_KEYBTERM, _______, _______, _______, _______, _______, _______, _______, KC_END,
  ...
  [_DVORAK] = LAYOUT_thread(
    ...
    _______, KC_SLSH, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH, KC_EQL,  _______,
