...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAIN] = LAYOUT_thread(
    ...
    KC_LCTL, KC_LALT, LGUI_T(KC_SPC),     KC_LGUI, KC_SPC, LT(_ALTLAYER, KC_SPC),       KC_RGUI, MO(_FN1), MO(_SYS), MO(_FN2), KC_PGDN
  ),

  [_NAVIGATION] = LAYOUT_thread(
    M_CMD_W, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, M_CMDBT,
