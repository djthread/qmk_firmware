...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAVIGATION] = LAYOUT_thread(
    ...
    _______, _______, _______,     _______, _______, _______,     TO(_MAIN), _______, _______, _______, _______
  ),
  ...
  [_FN1] = LAYOUT_thread(
    ...
    _______, _______, M_TEAMS, M_OUTLOOK, M_WTL, M_WTR,  M_WTOP, _______, _______, _______, _______, M_NEWBROWSER,     KC_PGUP,
  ...
  [_WEB] = LAYOUT_thread(
    ...
    _______, _______, _______,      _______, _______, _______,         TO(_MAIN), MO(_WEB2), KC_F, KC_C, KC_H
  ),
  ...
  [_CHOONS] = LAYOUT_thread(
    ...
    _______, _______, _______,      _______, _______, _______,         TO(_MAIN), _______, _______, KC_F8, M_MPREV
  ),
