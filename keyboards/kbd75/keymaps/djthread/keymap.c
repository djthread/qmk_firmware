...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = KEYMAP_ALL(
		M_CMD_TAB, KC_F1, KC_F2, KC_F3, M_CHATTERM, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, M_APPTERM, KC_F12, KC_NO, KC_NO, KC_DEL,
	...
	[_FUNCTION2] = KEYMAP_ALL(
		...
		KC_TRNS, KC_TRNS, M_TEAMS, M_OUTLOOK, M_WTL, M_WTR, M_WTOP, KC_TRNS, KC_TRNS, KC_TRNS, M_NEWBROWSER, KC_TRNS, KC_TRNS, KC_TRNS,
